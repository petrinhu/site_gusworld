<?php
/* Brinde (encarte §14): "a gente da a ferramenta". Recorrente: idêntico à #1.
   Dois cards: a fonte CC0 PixelOperatorMono (mostruario >=15px + download real do
   .woff2 do repo) e um papel de parede de terminal (preview CSS + download de um
   SVG gerado aqui, via data-URI: entregavel de verdade, zero asset novo). Estilos:
   edicao.css (.brinde). D-ACENTOS: prosa acentuada; kickers pixel = sem N
   maiusculo/acento (o guard). Sem prometer nada alem do que existe. */
