<?php
/* Free gift (insert §14): "we hand you the tool". Recurring: identical to #1.
   Two cards: the CC0 font PixelOperatorMono (specimen >=15px + a real download of
   the repo's .woff2) and a terminal wallpaper (CSS preview + a download of an SVG
   generated here, via data-URI: a real deliverable, zero new asset). Styles:
   edicao.css (.brinde). Pixel kickers avoid uppercase N (the guard). No promises
   beyond what exists. */
