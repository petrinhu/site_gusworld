...
líder recusou as duas opções levadas (carta curta ou guardar) e mandou virar reportagem, respondendo,
verbatim: *"Achados do gus sempre são especiais."* A regra, generalizada por ele e registrada como adendo
...
| **D16** | O achado do Gus Dragon sobre a arte do menu inicial (22/07) | **DECIDIDA pelo líder em 04/09/2026, e virou LEI (adendo datado da L-24 no `GODS_LAWS.md` do site).** Recusou carta curta e recusou guardar, e mandou virar reportagem. Verbatim: *"Achados do gus sempre são especiais."* Peça própria, **confirmado por ele em 04/09**: caixa ao fim da Reportagem de capa com âncora e abertura próprias, entrada própria na tabela de prioridade, porte S (§3.1); divisória em §5.4. A data da arte do menu: a peça escreve "no dia seguinte" (única fonte: a nota do quadro do jogo) e não crava data |
