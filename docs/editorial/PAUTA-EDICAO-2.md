...
> Artefato de saída do estágio **E1** do `PIPELINE-EDICAO`. Aguarda **GATE-PAUTA** (aprovação do editor-geral).
...
| 13 | Pôster central | **candidato a cheio** | O wireframe do Gus 3D (quase 1 milhão de faces para virar pixel de 48px) como pôster | 04/jun |
...
| 16 | A Entrevista | **fork do líder** | vazia com graça (a #1 já teve a longa) OU uma curta nova sobre "por que trocar de stack 2x" | - |
...
4. **Editorial** e **Gus lê o bus** (curtas).

Todo o resto é vazio-com-graça ou data-driven/recorrente.
