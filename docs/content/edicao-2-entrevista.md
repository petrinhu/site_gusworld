# Glyfesse #2 — A Entrevista (o Gus e o zumbi-ator) (rascunho v1)

> Seção in-fiction: o Gus entrevista um zumbi (arquétipo) que responde como ATOR. Voz: Gus (`gus@glyfesse>` + `//`) pergunta; o zumbi (`zumbi@glyfesse>` + `//` de diva) responde.
...
> Status: rascunho v1, aguardando GATE-CONTEUDO.

---

## pt-BR

`gus@glyfesse>` hoje a redação tem um convidado fora do padrão recebi um zumbi pra entrevistar diz que é ator não inimigo de fase
